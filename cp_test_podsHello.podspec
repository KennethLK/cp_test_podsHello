#
#  Be sure to run `pod spec lint cp_test_podsHello.podspec' to ensure this is a
...
s.source       = { :git => "https://github.com/KennethLK/cp_test_podsHello.git",  :branch=>"dev" :tag => "0.0.2" }
